                    ...
                    <div class="col-lg-12">
                      <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-user"></i> Add Ads <a class="collapse-link pull-right"><i class="fa fa-chevron-up"></i></a></h3>
                            </div>
                            <div class="panel-body">
                            {!! Form::open([ 'route'=> ['admin.ads.generate_video'],'autocomplete'=>'off', 'files'=> true, 'id'=>'page','method' => 'POST']) !!}
                            @include('admin.generate_video._partials.form')                                   
