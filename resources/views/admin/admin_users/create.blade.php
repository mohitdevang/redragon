                    ...
                    <div class="col-lg-12">
					  <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-user"></i> Add User <a class="collapse-link pull-right"><i class="fa fa-chevron-up"></i></a></h3>
                            </div>
                            <div class="panel-body">
							{!! Form::open([ 'route'=> ['admin.adm.user.store'],'autocomplete'=>'off', 'files'=> true, 'id'=>'admin_user', 'name' => 'admin_user','method' => 'POST']) !!}
