...
@section('title') Self Commission @endsection
@section('content')
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Self Commission <small> Overview</small>
                        </h1>
                    ...
                    <div class="col-lg-12">
                      <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-bar-chart-o fa-fw"></i> Self Commission <a class="collapse-link pull-right"><i class="fa fa-chevron-up"></i></a></h3>
                            </div>
                            <div class="panel-body">

                                
                                 <form method="get" action="{{route('admin.show.self_commission_report')}}">
     ...
     {{ csrf_field() }}
                         <div class="row" style="margin-bottom:10px;margin-top:10px;">
                            ...
                            <div class="col-md-6 mb-mt10">
                                ...
                                <a href="{{route('admin.show.self_commission_report')}}"> <button type="button" name="bulk_delete" class="btn btn-danger btn-rounded">cancel search</button></a>
                            </div>     
                        </div>
...
$total=0;
                    if(isset($from_date) && isset($to_date)){
                     ...
                     $total=DB::table('commision_tables')->where([['type','credit'],['plan','30'],['member_id',$user->unique_id],['created_at','<=',$to_date],['created_at','>=',$from_date]])->sum('amount');
                    }else{


                     $total=DB::table('commision_tables')->where([['type','credit'],['plan','30'],['member_id',$user->unique_id]])->sum('amount');
                 }
