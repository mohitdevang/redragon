  ...
  <div class="content">
                            ...
                            <div class="col-12">
                                <div class="card m-b-30">
                                    <div class="card-body">
                                        ...
                                        <h4 class="mt-0 header-title">Rewards</h4>
        ...
        <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tbody>
                                                ...
                                                @foreach($reward as $lc)

                                                <?php 
                                                $comm=DB::table('commision_tables')->where([['plan',$lc->award_id],['member_id',Auth::guard()->user()->unique_id],['rank','reward']])->first();
                                                if($comm){
