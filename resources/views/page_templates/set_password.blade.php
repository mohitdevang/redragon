...
@endif
                        <h5 class="font-18 text-center" style="color:#f44236;" >Set Password</h5>

    
                               <form class="form-horizontal m-t-30" method="POST" id="change-password-form" action="{{ route('update_new_password') }}">
                        @csrf

                        <input type="hidden" name="hid" value="{{$user_id}}">
    
                            <div class="form-group">
                                <div class="col-12">
                                        <label class="text-theme-dark">New Password</label>
                                    <input class="form-control form_input1" type="text"  name="newpwd" id="newpwd" required>
                                </div>
                                 ...
                                 <div class="form-group">
                                <div class="col-12">
                                        <label class="text-theme-dark">Confirm Password</label>
                                   <input class="form-control form_input1" type="text"  name="cpwd" required>
                                </div>
                             ...
                             <div class="form-group">
                                <div class="col-12">
                                        <label class="text-theme-dark">OTP</label>
                                   <input class="form-control form_input1" type="text"  name="otp" required >
                                </div>
